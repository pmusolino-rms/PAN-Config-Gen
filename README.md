...
ndghttpsclient<br />
PrettyTable</p>
<p>Once Everything is installed, you will need to edit the script and modify:<br />
...
<p>We can later move these to a config file or prompt for them.</p></article></body></html>
